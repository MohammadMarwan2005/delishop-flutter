...
abstract class $OrderListResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<OrderResponse> data});
}
...
class _$OrderListResponseImpl implements _OrderListResponse {
  const _$OrderListResponseImpl({required final List<OrderResponse> data})
      : _data = data;
...
abstract class _OrderListResponse implements OrderListResponse {
  const factory _OrderListResponse({required final List<OrderResponse> data}) =
