...
abstract class $LocationCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: "location_url") String url});
}
...
class _$LocationImpl implements _Location {
  const _$LocationImpl(
      ...
      @JsonKey(name: "location_url") required this.url});
  ...
  @override
  String toString() {
    return 'Location(id: $id, name: $name, url: $url)';
  }
...
abstract class _Location implements Location {
  const factory _Location(
          ...
          @JsonKey(name: "location_url") required final String url}) =
      _$LocationImpl;
